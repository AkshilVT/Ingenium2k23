  ...
  return (
    <div>
      ...
      <div className="grid gap-4 gap-y-9 lg:grid-cols-3 md:grid-cols-2 justify-items-center max-w-[1200px] my-0 mx-auto">
        {arr.map((item) => (
          <div key={item}>
            <div className="m-6 max-w-[300px]">
              <div className="w-[100%] h-[100%] aspect-[5/3] rounded-xl bg-cover bg-center bg-[url('https://tvseriescritic.files.wordpress.com/2016/10/stranger-things-bicycle-lights-children.jpg')]">
                <div className="data text-white p-3 place-self-end">
