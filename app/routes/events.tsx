  ...
  return (
    <div>
      ...
      <div className='grid gap-4 gap-y-9 lg:grid-cols-3 md:grid-cols-2 justify-items-center max-w-[1200px] my-0 mx-auto px-4'>
        {arr.map((item) => (
          <div
            className='p-6 max-w-[400px] min-h-[540px] aspect-[9/11]'
            key={item}
          >
            <div className="h-full group rounded-xl overflow-auto bg-cover bg-center bg-[url('public/poster.jpg')]">
              <div className='data text-white flex items-end h-full overflow-hidden '>
                <div className='content rounded-xl p-3 translate-y-[116px] group-hover:translate-y-0 duration-300 ease-linear backdrop-blur'>
